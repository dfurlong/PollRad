...
#
#	Rev 0.5	Feb 23, 2010	Added ability to clear values if jitter min is below min threshold.
#	Rev 0.6	Feb 24, 2010	Added CRT ouput adjustments for setting vertical scale max and min.
#	Rev 0.7 Feb 28, 2010	Added statistics output after chart
#
#######################################################################################################################
...
$aboutProgram = "Perl script PollRad.pl  (Rev 0.6 Feb 24, 2011)   Copywrite (c) 2010-2011 Amperion Inc.";
...
while (1) {
    ...
    print "Total Samples = $samples,  (40>  $sample40  >=30>  $sample30  >=25>  $sample25  >=20>  $sample20 >=15>  $sample15 )\n";
