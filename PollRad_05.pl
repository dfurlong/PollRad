...
$aboutProgram = "Perl script PollRad.pl  (Rev 0.5 Feb 22, 2011)   Copywrite (c) 2010-2011 Amperion Inc.";
...
print "Buffer Set Point = $jitterValue,  Threshold = $maxThreshold\n\n";
...
print LOGFILE "Buffer Set Point = $jitterValue,  Threshold = $maxThreshold\n\n";
close LOGFILE;
